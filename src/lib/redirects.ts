...
export const redirects: RedirectRule[] = [
  ...
  { source: "/guyons-canal-syndrome-nyc-hand-doct", destination: "/conditions/guyons-canal", permanent: true },
  { source: "/swan-neck-deformity-nyc-hand-doctor", destination: "/conditions/swan-neck-deformity", permanent: true },
  { source: "/dequervains-nyc-hand-doctor", destination: "/specialties/hand-wrist", permanent: true },
  { source: "/rheumatoid-arthritis-finger-hand-do", destination: "/conditions/rheumatoid-arthritis-hand", permanent: true },
  ...
  { source: "/boutonierre-deformity-hand-ortho", destination: "/conditions/boutonniere-deformity", permanent: true },
  ...
  { source: "/arthritis-hand-fingers", destination: "/conditions/hand-arthritis", permanent: true },
  { source: "/mallet-finger-hand-doctor-nyc", destination: "/conditions/mallet-finger", permanent: true },
  { source: "/tfcc-wrist-doctor-nyc", destination: "/conditions/tfcc-tear", permanent: true },
  { source: "/kienbocks-hand-doctor-nyc", destination: "/conditions/kienbocks-disease", permanent: true },
  { source: "/intersection-syndrome-nyc-ortho", destination: "/conditions/intersection-syndrome", permanent: true },
  { source: "/nerve-laceration-doctor-nyc", destination: "/conditions/nerve-laceration", permanent: true },
  { source: "/tendon-laceration-doctor-nyc", destination: "/conditions/tendon-laceration", permanent: true },
  ...
  { source: "/chronic-forearm-compartment-syndrom", destination: "/conditions/forearm-compartment-syndrome", permanent: true },
  ...
  { source: "/distal-humerus-fracture-nyc", destination: "/conditions/distal-humerus-fracture", permanent: true },
  { source: "/distal-bicep-tendonitis-nyc", destination: "/conditions/distal-biceps-tendonitis", permanent: true },
  ...
  { source: "/elbow-arthritis-ortho-nyc", destination: "/conditions/elbow-arthritis", permanent: true },
  ...
  { source: "/olecranon-bursitis-orthopedic-nyc", destination: "/conditions/olecranon-bursitis", permanent: true },
  ...
  { source: "/adhesive-capsulitis-shoulder-pain", destination: "/conditions/frozen-shoulder", permanent: true },
  ...
  { source: "/patellar-dislocation-knee-ortho-nyc", destination: "/conditions/patellar-instability", permanent: true },
  { source: "/pfs-knee-pain", destination: "/specialties/knee", permanent: true },
  { source: "/knee-baker-cyst-nyc", destination: "/conditions/bakers-cyst", permanent: true },
  ...
  { source: "/knee-arthritis-pain-nyc-ortho", destination: "/conditions/knee-arthritis", permanent: true },
  ...
  { source: "/stem-cell-and-ortho-biologics", destination: "/conditions/prp-bmac", permanent: true },
  ...
  { source: "/posterior-tibial-tendonitis-ortho-n", destination: "/conditions/posterior-tibial-tendonitis", permanent: true },
  { source: "/ankle-fracture-ortho-nyc", destination: "/conditions/ankle-fracture", permanent: true },
  { source: "/foot-ankle-best-orthopedic-doctor", destination: "/conditions", permanent: true },
  { source: "/peroneal-tendonitis-ortho-nyc", destination: "/conditions/peroneal-tendonitis", permanent: true },
  { source: "/lisfranc-sprain-foot-pain-nyc", destination: "/conditions/lisfranc-injury", permanent: true },
  { source: "/severs-disease-ortho-nyc", destination: "/conditions/severs-disease", permanent: true },
