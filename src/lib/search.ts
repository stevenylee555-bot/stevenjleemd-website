...
const conditionSynonyms: Record<string, string> = {
  ...
  "trigger-finger": "trigger finger locking finger catching finger stenosing tenosynovitis finger stuck a1 pulley release injection",
  "wrist-arthroscopy": "wrist arthroscopy scope minimally invasive wrist surgery tfcc scapholunate ligament ulnar impaction diagnostic arthroscopy",
