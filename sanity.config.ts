    ...
    presentationTool({
      ...
      resolve: {
        locations: {
          ...
          publicationsPage: defineLocations({
            locations: [{ title: "Publications & Research", href: "/about/publications" }],
          }),
          cvPage: defineLocations({
            locations: [{ title: "Curriculum Vitae", href: "/about/cv" }],
          }),
